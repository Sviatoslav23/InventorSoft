...
Pros: fast data ordering algorithm, each bit takes values from a small range, then each ordering cycle can be performed quickly and with low memory consumption.

Cons: The topic of Radix sort efficiency in comparison with other sorting algorithms is somewhat confusing and is the subject of many misunderstandings.
